...
replicate_pipes = {
    ...
    'Image Editing': ['black-forest-labs/flux-fill-pro', 'black-forest-labs/flux-redux-dev', 'zsxkib/dream-o', 'ideogram-ai/ideogram-v2', 'ideogram-ai/ideogram-v2-turbo', 'black-forest-labs/flux-depth-pro', 'black-forest-labs/flux-canny-pro', 'adirik/t2i-adapter-sdxl-depth-midas', 'adirik/stylemc', 'adirik/masactrl-sdxl', 'adirik/kosmos-g', 'adirik/masactrl-stable-diffusion-v1-4', 'adirik/t2i-adapter-sdxl-lineart', 'adirik/t2i-adapter-sdxl-canny', 'adirik/t2i-adapter-sdxl-sketch', 'adirik/t2i-adapter-sdxl-openpose', 'lambdal/image-mixer', 'fofr/color-matcher', 'logerzhu/ad-inpaint', 'rossjillian/controlnet', 'daanelson/plug_and_play_image_translation', 'cjwbw/pix2pix-zero', 'pollinations/modnet', 'arielreplicate/deoldify_image', 'timothybrooks/instruct-pix2pix', 'andreasjansson/stable-diffusion-inpainting', 'cjwbw/rembg', 'orpatashnik/styleclip', 'cjwbw/repaint', 'storymy/take-off-eyeglasses', 'sujaykhandekar/object-removal'],
    'Custom':[],
}

...
replicate_pipes = {
    ...
    'AI Face Generator': ['tencentarc/photomaker', 'tencentarc/photomaker-style', 'scamai/faceswap', 'fofr/face-to-many', 'zsxkib/instant-id', 'zsxkib/pulid', 'zsxkib/flash-face', 'fofr/become-image', 'fofr/face-to-sticker', 'grandlineai/instant-id-photorealistic', 'grandlineai/instant-id-artistic', 'lucataco/modelscope-facefusion', 'lucataco/ip_adapter-face-inpaint', 'lucataco/ip_adapter-sdxl-face', 'chigozienri/mediapipe-face', 'lucataco/ip_adapter-face', 'cjwbw/face-align-cog'],

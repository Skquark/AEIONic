...
replicate_pipes = {
    'Text-to-Image': ['black-forest-labs/flux-1.1-pro', 'black-forest-labs/flux-pro', 'black-forest-labs/flux-schnell', 'ideogram-ai/ideogram-v2a', 'ideogram-ai/ideogram-v2a-turbo', 'ideogram-ai/ideogram-v2', 'blog/ideogram-v2-inpainting', 'recraft-ai/recraft-v3-svg', 'fofr/any-comfyui-workflow', 'fofr/any-comfyui-workflow-a100', 'vetkastar/fooocus', 'google/imagen-3', 'nvidia/sana', 'black-forest-labs/flux-1.1-pro-ultra', 'recraft-ai/recraft-v3', 'stability-ai/stable-diffusion-3.5-large', 'prunaai/hidream-l1-full', 'prunaai/hidream-l1-dev', 'prunaai/hidream-l1-fast', 'chenxwh/onediffusion', 'bytedance/sdxl-lightning-4step', 'luma/photon-flash', 'luma/photon', 'stability-ai/stable-diffusion-3.5-medium', 'stability-ai/stable-diffusion-3.5-large-turbo', 'ideogram-ai/ideogram-v2-turbo', 'black-forest-labs/flux-dev', 'fofr/aura-flow', 'stability-ai/sdxl', 'fofr/sticker-maker', 'delta-lock/ponynai3', 'ai-forever/kandinsky-2', 'ai-forever/kandinsky-2.2', 'playgroundai/playground-v2.5-1024px-aesthetic', 'adirik/realvisxl-v4.0', 'datacte/proteus-v0.3', 'stability-ai/stable-diffusion-inpainting', 'batouresearch/sdxl-controlnet-lora', 'datacte/proteus-v0.2', 'adirik/realvisxl-v3.0-turbo', 'fofr/latent-consistency-model', 'fofr/realvisxl-v3-multi-controlnet-lora', 'lucataco/open-dalle-v1.1', 'fofr/sdxl-multi-controlnet-lora', 'lucataco/dreamshaper-xl-turbo', 'lucataco/pixart-xl-2', 'lucataco/realvisxl2-lcm', 'lucataco/realvisxl-v2.0', 'lucataco/ssd-1b', 'fofr/sdxl-emoji', 'lucataco/realistic-vision-v5', 'stability-ai/stable-diffusion', 'ai-forever/kandinsky-2-1', 'jagilley/controlnet-scribble', 'tstramer/material-diffusion', 'foundationvision/infinity', 'alexgenovese/flux-sd3-flow-edit', 'orbin-ahmed/interior', 'youtubeautomation23/youtube-thumbnail-generator', 'subhash25rawat/flawless-text', 'visoar/hipng', 'adriiita/photoshoot', 'thefluxtrain/oye-cartoon', 'simbrams/ri', 'jichengdu/flux-pulid', 'kelvincai522/photomaker-v1-lightning', 'lucataco/cogview4-6b', 'lightweight-ai/model3_4', 'impetusdesign/vhx-gzp', 'lucataco/flux-in-context', 'ostris/flex.1-alpha'],
    'Text-to-Video': ['minimax/video-01', 'tencent/hunyuan-video', 'zsxkib/hunyuan-video-lora', 'lucataco/hunyuanvideo', 'wavespeedai/wan-2.1-i2v-480p', 'wavespeedai/wan-2.1-t2v-480p', 'wavespeedai/wan-2.1-i2v-720p', 'wavespeedai/wan-2.1-t2v-720p', 'fofr/wan2.1-with-lora', 'wavespeedai/wan-2.1-i2v-720p', 'wavespeedai/wan-2.1-t2v-720p', 'wan-video/wan-2.1-1.3b', 'andreasjansson/wan-1.3b-inpaint', 'lucataco/wan-2.1-1.3b-vid2vid', 'lucataco/wan2.1-i2v-lora', 'google/veo-2', 'minimax/video-01-director', 'minimax/video-01-live', 'luma/ray', 'luma/ray-2-720p', 'luma/ray-2-540p', 'luma/ray-flash-2-720p', 'luma/ray-flash-2-540p', 'haiper-ai/haiper-video-2', 'genmoai/mochi-1', 'fofr/ltx-video', 'zsxkib/hunyuan-video2video', 'kwaivgi/kling-v1.6-pro', 'kwaivgi/kling-v1.6-standard', 'zsxkib/samurai', 'zsxkib/pyramid-flow', 'cuuupid/cogvideox-5b', 'meta/sam-2-video', 'fofr/tooncrafter', 'fofr/video-morpher', 'camenduru/animatediff-lightning-4-step', 'cjwbw/videocrafter', 'ali-vilab/i2vgen-xl', 'open-mmlab/pia', 'chenxwh/nova-t2v', 'zsxkib/animatediff-illusions', 'lucataco/hotshot-xl', 'zsxkib/animatediff-prompt-travel', 'zsxkib/animate-diff', 'lucataco/animate-diff', 'anotherjesse/zeroscope-v2-xl', 'cjwbw/controlvideo', 'cjwbw/text2video-zero', 'cjwbw/damo-text-to-video', 'andreasjansson/tile-morph', 'pollinations/stable-diffusion-dance', 'arielreplicate/deoldify_video', 'pollinations/real-basicvsr-video-superresolution', 'pollinations/tune-a-video', 'arielreplicate/robust_video_matting', 'arielreplicate/stable_diffusion_infinite_zoom', 'andreasjansson/stable-diffusion-animation', 'nateraw/stable-diffusion-videos', 'deforum/deforum_stable_diffusion', 'fofr/video-morpher', 'zsxkib/step-video-t2v', 'tmappdev/change_video_bg', 'lucataco/dotted-video'],
    ...
    'AI Music Generation': ['minimax/music-01', 'meta/musicgen', 'lucataco/magnet', 'zsxkib/flux-music', 'stackadoc/stable-audio-open-1.0', 'zsxkib/mmaudio', 'charlesmccarthy/musicgen', 'nateraw/musicgen-songstarter-v0.2', 'sakemin/musicgen-remixer', 'sakemin/musicgen-stereo-chord', 'declare-lab/mustango', 'sakemin/musicgen-chord', 'fofr/musicgen-choral', 'nateraw/audio-super-resolution', 'andreasjansson/musicgen-looper', 'haoheliu/audio-ldm', 'andreasjansson/cantable-diffuguesion', 'riffusion/riffusion', 'annahung31/emopia', 'allenhung1025/looptest', 'harmonai/dance-diffusion', 'andreasjansson/music-inpainting-bert', 'ardianfe/demucs-prod', 'ryan5453/demucs', 'jourdelune/diffrhythm', 'mtg/music-arousal-valence'],
    ...
    'AI Face Generator': ['zsxkib/instant-id', 'zsxkib/pulid', 'tencentarc/photomaker', 'tencentarc/photomaker-style', 'scamai/faceswap', 'fofr/face-to-many', 'zsxkib/flash-face', 'fofr/become-image', 'fofr/face-to-sticker', 'grandlineai/instant-id-photorealistic', 'grandlineai/instant-id-artistic', 'lucataco/modelscope-facefusion', 'lucataco/ip_adapter-face-inpaint', 'lucataco/ip_adapter-sdxl-face', 'chigozienri/mediapipe-face', 'lucataco/ip_adapter-face', 'cjwbw/face-align-cog'],
    ...
    'Language Models': ['anthropic/claude-3.7-sonnet', 'anthropic/claude-3.5-haiku', 'anthropic/claude-3.5-sonnet', 'lucataco/r1-1776-70b', 'deepseek-ai/deepseek-r1', 'meta/meta-llama-3-70b', 'meta/meta-llama-3-70b-instruct', 'meta/meta-llama-3-8b', 'meta/meta-llama-3-8b-instruct', 'google-deepmind/gemma-7b', 'google-deepmind/gemma-2b', 'google-deepmind/gemma-7b-it', 'google-deepmind/gemma-2b-it', 'lucataco/phixtral-2x2_8', 'lucataco/qwen1.5-72b', 'lucataco/qwen1.5-7b', 'adirik/mamba-2.8b', 'adirik/mamba-130m', 'adirik/mamba-370m', 'adirik/mamba-790m', 'adirik/mamba-2.8b-slimpj', 'adirik/mamba-1.4b', 'lucataco/phi-2', 'nateraw/nous-hermes-2-solar-10.7b', 'kcaverly/nous-hermes-2-yi-34b-gguf', '01-ai/yi-34b-chat', '01-ai/yi-6b-chat', '01-ai/yi-6b', 'nateraw/nous-hermes-llama2-awq', 'stability-ai/stablelm-tuned-alpha-7b', 'replicate/flan-t5-xl', 'replicate/gpt-j-6b', 'replicate/llama-7b'],

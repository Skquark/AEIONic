...
replicate_pipes = {
    ...
    'AI Face Generator': ['zsxkib/instant-id', 'zsxkib/pulid', 'easel/ai-avatars', 'zsxkib/infinite-you', 'tuannha/instant-character', 'tencentarc/photomaker', 'tencentarc/photomaker-style', 'scamai/faceswap', 'fofr/face-to-many', 'zsxkib/flash-face', 'fofr/become-image', 'fofr/face-to-sticker', 'grandlineai/instant-id-photorealistic', 'grandlineai/instant-id-artistic', 'lucataco/modelscope-facefusion', 'tmappdev/lipsync', 'lucataco/ip_adapter-face-inpaint', 'lucataco/ip_adapter-sdxl-face', 'chigozienri/mediapipe-face', 'lucataco/ip_adapter-face', 'cjwbw/face-align-cog', 'mertguvencli/face-swap-with-indexes', 'zsxkib/sonic'],

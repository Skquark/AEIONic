...
replicate_pipes = {
    'Text-to-Image': ['black-forest-labs/flux-1.1-pro', 'black-forest-labs/flux-pro', 'black-forest-labs/flux-schnell', 'ideogram-ai/ideogram-v2', 'blog/ideogram-v2-inpainting', 'recraft-ai/recraft-v3-svg', 'fofr/any-comfyui-workflow', 'nvidia/sana', 'black-forest-labs/flux-1.1-pro-ultra', 'recraft-ai/recraft-v3', 'stability-ai/stable-diffusion-3.5-large', 'bytedance/sdxl-lightning-4step', 'luma/photon-flash', 'luma/photon', 'stability-ai/stable-diffusion-3.5-medium', 'stability-ai/stable-diffusion-3.5-large-turbo', 'ideogram-ai/ideogram-v2-turbo', 'black-forest-labs/flux-dev', 'fofr/aura-flow', 'stability-ai/sdxl', 'fofr/sticker-maker', 'ai-forever/kandinsky-2', 'ai-forever/kandinsky-2.2', 'playgroundai/playground-v2.5-1024px-aesthetic', 'adirik/realvisxl-v4.0', 'datacte/proteus-v0.3', 'stability-ai/stable-diffusion-inpainting', 'batouresearch/sdxl-controlnet-lora', 'datacte/proteus-v0.2', 'adirik/realvisxl-v3.0-turbo', 'fofr/latent-consistency-model', 'fofr/realvisxl-v3-multi-controlnet-lora', 'lucataco/open-dalle-v1.1', 'fofr/sdxl-multi-controlnet-lora', 'lucataco/dreamshaper-xl-turbo', 'lucataco/pixart-xl-2', 'lucataco/realvisxl2-lcm', 'lucataco/realvisxl-v2.0', 'lucataco/ssd-1b', 'fofr/sdxl-emoji', 'lucataco/realistic-vision-v5', 'stability-ai/stable-diffusion', 'ai-forever/kandinsky-2-1', 'jagilley/controlnet-scribble', 'tstramer/material-diffusion'],
    'Text-to-Video': ['minimax/video-01', 'tencent/hunyuan-video', 'minimax/video-01-live', 'luma/ray', 'haiper-ai/haiper-video-2', 'genmoai/mochi-1', 'fofr/ltx-video', 'zsxkib/hunyuan-video2video', 'zsxkib/samurai', 'zsxkib/pyramid-flow', 'cuuupid/cogvideox-5b', 'meta/sam-2-video', 'fofr/tooncrafter', 'fofr/video-morpher', 'camenduru/animatediff-lightning-4-step', 'cjwbw/videocrafter', 'ali-vilab/i2vgen-xl', 'open-mmlab/pia', 'zsxkib/animatediff-illusions', 'lucataco/hotshot-xl', 'zsxkib/animatediff-prompt-travel', 'zsxkib/animate-diff', 'lucataco/animate-diff', 'anotherjesse/zeroscope-v2-xl', 'cjwbw/controlvideo', 'cjwbw/text2video-zero', 'cjwbw/damo-text-to-video', 'andreasjansson/tile-morph', 'pollinations/stable-diffusion-dance', 'arielreplicate/deoldify_video', 'pollinations/real-basicvsr-video-superresolution', 'pollinations/tune-a-video', 'arielreplicate/robust_video_matting', 'arielreplicate/stable_diffusion_infinite_zoom', 'andreasjansson/stable-diffusion-animation', 'nateraw/stable-diffusion-videos', 'deforum/deforum_stable_diffusion'],
    'Image-to-Text': ['lucataco/moondream2', 'yorickvp/llava-13b', 'salesforce/blip', 'zsxkib/molmo-7b', 'fofr/batch-image-captioning', 'zsxkib/wd-image-tagger', 'daanelson/minigpt-4', 'zsxkib/blip-3', 'zsxkib/uform-gen', 'andreasjansson/blip-2', 'pharmapsychotic/clip-interrogator', 'nohamoamary/image-captioning-with-visual-attention', 'rmokady/clip_prefix_caption', 'methexis-inc/img2prompt', 'j-min/clip-caption-reward'],
    'Speech-to-Text': ['vaibhavs10/incredibly-fast-whisper', 'victor-upmeet/whisperx', 'cjwbw/seamless_communication', 'openai/whisper', 'thomasmol/whisper-diarization', 'nvidia/parakeet-rnnt-1.1b', 'adidoes/whisperx-video-transcribe'],
    'Super-Resolution': ['batouresearch/magic-image-refiner', 'batouresearch/high-resolution-controlnet-tile', 'nightmareai/real-esrgan', 'daanelson/real-esrgan-a100', 'philz1337x/clarity-upscaler', 'zsyoaoa/invsr', 'zsxkib/aura-sr-v2', 'zsxkib/aura-sr', 'tencentarc/gfpgan', 'cjwbw/supir', 'cswry/seesr', 'lucataco/pasd-magnify', 'lucataco/stable-diffusion-x4-upscaler', 'juergengunz/ultimate-portrait-upscale', 'lucataco/demofusion-enhance', 'lucataco/controlnet-tile', 'fewjative/ultimate-sd-upscale', 'zsxkib/diffbir', 'cjwbw/real-esrgan', 'mv-lab/swin2sr', 'jingyunliang/hcflow-sr', 'xinntao/esrgan', 'cjwbw/rudalle-sr', 'jingyunliang/swinir', 'sczhou/codeformer', 'nightmareai/latent-sr'],
    'AI Music Generation': ['minimax/music-01', 'meta/musicgen', 'lucataco/magnet', 'zsxkib/flux-music', 'stackadoc/stable-audio-open-1.0', 'charlesmccarthy/musicgen', 'nateraw/musicgen-songstarter-v0.2', 'sakemin/musicgen-remixer', 'sakemin/musicgen-stereo-chord', 'declare-lab/mustango', 'sakemin/musicgen-chord', 'fofr/musicgen-choral', 'nateraw/audio-super-resolution', 'andreasjansson/musicgen-looper', 'haoheliu/audio-ldm', 'andreasjansson/cantable-diffuguesion', 'riffusion/riffusion', 'annahung31/emopia', 'allenhung1025/looptest', 'harmonai/dance-diffusion', 'andreasjansson/music-inpainting-bert'],
    'Sing with Voices': ['replicate/train-rvc-model', 'zsxkib/create-rvc-dataset', 'zsxkib/realistic-voice-cloning', 'pseudoram/rvc-v2', 'nateraw/autotune', 'lucataco/singing_voice_conversion', 'zsxkib/tortoise-then-rvc'],
    '3D Models': ['firtoz/trellis', 'adirik/dreamgaussian', 'adirik/text2tex', 'camenduru/tripo-sr', 'adirik/wonder3d', 'camenduru/lgm-ply-to-glb', 'lucataco/deep3d', 'camenduru/lgm', 'adirik/imagedream', 'adirik/texture', 'adirik/mvdream', 'jd7h/zero123plusplus', 'cjwbw/shap-e'],
    'Utilities': ['fofr/audio-to-waveform', 'fofr/controlnet-preprocessors', 'fofr/video-to-frames', 'fofr/frames-to-video', 'fofr/toolkit', 'jd7h/edit-video-by-editing-text', 'fictions-ai/autocaption', 'midllle/material-maker', 'lucataco/depth-anything-video', 'lucataco/img-and-audio2video', 'charlesmccarthy/addwatermark', 'falcons-ai/nsfw_image_detection', 'chigozienri/image-urls-to-video'],
    'Vision Models': ['lucataco/moondream2', 'yorickvp/llava-13b', 'yorickvp/llava-v1.6-mistral-7b', 'daanelson/minigpt-4', 'yorickvp/llava-v1.6-34b', 'yorickvp/llava-v1.6-vicuna-13b', 'zsxkib/uform-gen', 'lucataco/moondream1', 'adirik/kosmos-g', 'lucataco/qwen-vl-chat', 'adirik/owlvit-base-patch32', 'cjwbw/internlm-xcomposer', 'cjwbw/unival', 'cjwbw/unidiffuser'],
    'Text-to-Speech': ['lucataco/xtts-v2', 'adirik/styletts2', 'suno-ai/bark', 'zsxkib/realistic-voice-cloning', 'batouresearch/spanish-f5-tts', 'x-lance/f5-tts', 'platform-kit/mars5-tts', 'chenxwh/openvoice', 'declare-lab/tango', 'cjwbw/voicecraft', 'cjwbw/parler-tts', 'camenduru/metavoice', 'lucataco/pheme', 'cjwbw/seamless_communication', 'awerks/neon-tts', 'afiaka87/tortoise-tts'],
    'Remove Backgrounds': ['men1scus/birefnet', 'cjwbw/rmgb', 'arielreplicate/robust_video_matting', 'lucataco/remove-bg', 'lucataco/rembg-video', 'alexgenovese/remove-background-bria-2', 'tahercoolguy/video_background_remover_appender', 'smoretalk/rembg-enhance', 'codeplugtech/background_remover', 'pollinations/modnet', 'cjwbw/rembg'],
    'AI Face Generator': ['tencentarc/photomaker', 'tencentarc/photomaker-style', 'fofr/face-to-many', 'zsxkib/instant-id', 'zsxkib/pulid', 'zsxkib/flash-face', 'fofr/become-image', 'fofr/face-to-sticker', 'grandlineai/instant-id-photorealistic', 'grandlineai/instant-id-artistic', 'lucataco/modelscope-facefusion', 'lucataco/ip_adapter-face-inpaint', 'lucataco/ip_adapter-sdxl-face', 'chigozienri/mediapipe-face', 'lucataco/ip_adapter-face', 'cjwbw/face-align-cog'],
    ...
    'Image Editing': ['black-forest-labs/flux-fill-pro', 'black-forest-labs/flux-redux-dev', 'ideogram-ai/ideogram-v2', 'ideogram-ai/ideogram-v2-turbo', 'black-forest-labs/flux-depth-pro', 'black-forest-labs/flux-canny-pro', 'adirik/t2i-adapter-sdxl-depth-midas', 'adirik/stylemc', 'adirik/masactrl-sdxl', 'adirik/kosmos-g', 'adirik/masactrl-stable-diffusion-v1-4', 'adirik/t2i-adapter-sdxl-lineart', 'adirik/t2i-adapter-sdxl-canny', 'adirik/t2i-adapter-sdxl-sketch', 'adirik/t2i-adapter-sdxl-openpose', 'lambdal/image-mixer', 'logerzhu/ad-inpaint', 'rossjillian/controlnet', 'daanelson/plug_and_play_image_translation', 'cjwbw/pix2pix-zero', 'pollinations/modnet', 'arielreplicate/deoldify_image', 'timothybrooks/instruct-pix2pix', 'andreasjansson/stable-diffusion-inpainting', 'cjwbw/rembg', 'orpatashnik/styleclip', 'cjwbw/repaint', 'storymy/take-off-eyeglasses', 'sujaykhandekar/object-removal'],
    'Custom':[],
}

...
replicate_pipes = {
    'Text-to-Image':['stability-ai/sdxl', 'stability-ai/stable-diffusion-inpainting', 'ai-forever/kandinsky-2.2', 'datacte/proteus-v0.2', 'fofr/sdxl-emoji', 'ai-forever/kandinsky-2', 'black-forest-labs/flux-dev', 'tstramer/material-diffusion', 'datacte/proteus-v0.3', 'playgroundai/playground-v2.5-1024px-aesthetic', 'fofr/latent-consistency-model', 'lucataco/ssd-1b', 'fofr/realvisxl-v3-multi-controlnet-lora', 'batouresearch/sdxl-controlnet-lora', 'fofr/any-comfyui-workflow', 'fofr/sticker-maker', 'lucataco/realvisxl2-lcm', 'lucataco/realvisxl-v2.0', 'fofr/sdxl-multi-controlnet-lora', 'lucataco/dreamshaper-xl-turbo', 'lucataco/open-dalle-v1.1', 'adirik/realvisxl-v3.0-turbo', 'ai-forever/kandinsky-2-1', 'nightmareai/disco-diffusion', 'lucataco/pixart-xl-2', 'adirik/realvisxl-v4.0', 'lucataco/realistic-vision-v5'],
    'Text-to-Video':['anotherjesse/zeroscope-v2-xl', 'lucataco/animate-diff', 'deforum/deforum_stable_diffusion', 'lucataco/hotshot-xl', 'cjwbw/damo-text-to-video', 'andreasjansson/stable-diffusion-animation', 'ali-vilab/i2vgen-xl', 'nateraw/stable-diffusion-videos', 'zsxkib/animate-diff', 'arielreplicate/robust_video_matting', 'cjwbw/text2video-zero', 'arielreplicate/stable_diffusion_infinite_zoom', 'cjwbw/videocrafter', 'wyhsirius/lia', 'zsxkib/animatediff-prompt-travel', 'arielreplicate/deoldify_video', 'charlesmccarthy/hotshot-a40', 'cloneofsimo/hotshot-xl-lora-controlnet'],
    'Make 3D Stuff':['cjwbw/shap-e', 'jd7h/zero123plusplus', 'camenduru/tripo-sr', 'camenduru/lgm', 'adirik/wonder3d', 'adirik/texture', 'adirik/mvdream', 'adirik/imagedream', 'camenduru/lgm-ply-to-glb', 'adirik/text2tex'],
    'Image-to-Text':['salesforce/blip', 'andreasjansson/blip-2', 'yorickvp/llava-13b', 'methexis-inc/img2prompt', 'pharmapsychotic/clip-interrogator', 'rmokady/clip_prefix_caption', 'daanelson/minigpt-4', 'j-min/clip-caption-reward', 'nohamoamary/image-captioning-with-visual-attention', 'zsxkib/uform-gen', 'zsxkib/molmo-7b'],
    'Speech-to-Text':['openai/whisper', 'vaibhavs10/incredibly-fast-whisper', 'thomasmol/whisper-diarization', 'victor-upmeet/whisperx', 'cjwbw/seamless_communication', 'nvlabs/parakeet-rnnt-1.1b'],
    'Text-to-Speech':['adirik/styletts2', 'adirik/hierspeechpp', 'suno-ai/bark', 'x-lance/f5-tts', 'lucataco/xtts-v2', 'zsxkib/realistic-voice-cloning', 'afiaka87/tortoise-tts', 'cjwbw/seamless_communication', 'awerks/neon-tts', 'declare-lab/tango', 'camenduru/metavoice'],
    'Image Editing':['logerzhu/ad-inpaint', 'pollinations/modnet', 'alaradirik/t2i-adapter-sdxl-depth-midas', 'adirik/masactrl-sdxl', 'adirik/stylemc', 'tencentarc/gfpgan', 'sczhou/codeformer', 'rossjillian/controlnet', 'cjwbw/rembg', 'adirik/t2i-adapter-sdxl-lineart', 'storymy/take-off-eyeglasses', 'adirik/t2i-adapter-sdxl-canny', 'sujaykhandekar/object-removal', 'adirik/t2i-adapter-sdxl-sketch', 'lambdal/image-mixer', 'daanelson/plug_and_play_image_translation', 'cjwbw/pix2pix-zero'],
    'Remove Backgrounds':['cjwbw/rembg', 'smoretalk/rembg-enhance', 'arielreplicate/robust_video_matting', 'camenduru/bria-rmbg', 'lucataco/remove-bg'],
    'Utilities':['falcons-ai/nsfw_image_detection', 'cjwbw/rembg', 'smoretalk/rembg-enhance', 'fofr/audio-to-waveform', 'arielreplicate/robust_video_matting', 'fofr/controlnet-preprocessors', 'charlesmccarthy/addwatermark', 'fictions-ai/autocaption', 'fofr/video-to-frames', 'camenduru/bria-rmbg', 'fofr/toolkit', 'lucataco/img-and-audio2video', 'fofr/frames-to-video', 'chigozienri/image-urls-to-video', 'jd7h/edit-video-by-editing-text', 'lucataco/deep3d', 'lucataco/depth-anything-video'],
    'AI Face Generator':['fofr/face-to-many', 'tencentarc/photomaker', 'fofr/face-to-sticker', 'tencentarc/photomaker-style', 'zsxkib/instant-id', 'zsxkib/pulid', 'fofr/become-image', 'lucataco/ip_adapter-sdxl-face', 'lucataco/modelscope-facefusion', 'lucataco/ip_adapter-face-inpaint', 'lucataco/ip_adapter-face'],
    'Text Recognition (OCR)':['abiruyt/text-extract-ocr', 'cudanexus/ocr-surya', 'mickeybeurskens/latex-ocr', 'sulthonmb/ocr-receipt'],
    'Embedding Models':['andreasjansson/clip-features', 'daanelson/imagebind', 'replicate/all-mpnet-base-v2', 'nateraw/bge-large-en-v1.5', 'lucataco/nomic-embed-text-v1', 'adirik/e5-mistral-7b-instruct', 'adirik/multilingual-e5-large'],
    'AI Image Restoration':['google-research/maxim', 'tencentarc/gfpgan', 'sczhou/codeformer', 'jingyunliang/swinir', 'megvii-research/nafnet', 'microsoft/bringing-old-photos-back-to-life', 'cjwbw/bigcolor', 'arielreplicate/deoldify_image', 'tencentarc/vqfr', 'yangxy/gpen', 'cjwbw/supir', 'piddnad/ddcolor', 'codeslake/ifan-defocus-deblur', 'cjwbw/night-enhancement', 'batouresearch/magic-style-transfer', 'cjwbw/supir-v0f', 'mv-lab/instructir', 'cjwbw/supir-v0q', 'codeplugtech/object_remover'],
    'Super Resolution':['batouresearch/magic-image-refiner', 'nightmareai/real-esrgan', 'jingyunliang/swinir', 'philz1337x/clarity-upscaler', 'mv-lab/swin2sr', 'cjwbw/real-esrgan', 'batouresearch/high-resolution-controlnet-tile', 'cjwbw/rudalle-sr', 'jingyunliang/hcflow-sr', 'fewjative/ultimate-sd-upscale', 'cjwbw/supir', 'zsxkib/diffbir', 'nightmareai/latent-sr', 'xinntao/esrgan', 'cswry/seesr', 'juergengunz/ultimate-portrait-upscale', 'lucataco/pasd-magnify', 'lucataco/demofusion-enhance', 'lucataco/stable-diffusion-x4-upscaler', 'lucataco/controlnet-tile', 'zsxkib/aura-sr', 'zsxkib/aura-sr-v2'],
    'Language Models':['meta/meta-llama-3-8b-instruct', 'meta/meta-llama-3-70b-instruct', 'meta/meta-llama-3-8b', 'meta/llama-2-7b-chat', 'meta/llama-2-70b-chat', 'meta/llama-2-13b-chat', 'mistralai/mistral-7b-v0.1', 'meta/meta-llama-3-70b', '01-ai/yi-34b-chat', '01-ai/yi-6b', 'replicate/flan-t5-xl', 'stability-ai/stablelm-tuned-alpha-7b', 'replicate/llama-7b', 'google-deepmind/gemma-2b-it', 'google-deepmind/gemma-7b-it', 'nateraw/nous-hermes-2-solar-10.7b', 'kcaverly/nous-hermes-2-yi-34b-gguf', 'replicate/gpt-j-6b', 'nateraw/nous-hermes-llama2-awq', 'google-deepmind/gemma-7b', '01-ai/yi-6b-chat', 'lucataco/qwen1.5-72b', 'lucataco/phi-2', 'google-deepmind/gemma-2b', 'lucataco/qwen1.5-14b', 'lucataco/phixtral-2x2_8', 'adirik/mamba-2.8b', 'lucataco/qwen1.5-7b', 'adirik/mamba-130m', 'adirik/mamba-1.4b', 'adirik/mamba-2.8b-slimpj', 'adirik/mamba-790m', 'adirik/mamba-370m'],
    'Control-Net':['jagilley/controlnet-scribble', 'jagilley/controlnet-hough', 'jagilley/controlnet-canny', 'jagilley/controlnet-depth2img', 'jagilley/controlnet-hed', 'jagilley/controlnet-normal', 'jagilley/controlnet-pose', 'jagilley/controlnet-seg'],
    'Image Editing':['logerzhu/ad-inpaint', 'pollinations/modnet', 'alaradirik/t2i-adapter-sdxl-depth-midas', 'adirik/masactrl-sdxl', 'adirik/stylemc', 'tencentarc/gfpgan', 'sczhou/codeformer', 'rossjillian/controlnet', 'cjwbw/rembg', 'andreasjansson/stable-diffusion-inpainting', 'orpatashnik/styleclip', 'timothybrooks/instruct-pix2pix', 'arielreplicate/deoldify_image', 'adirik/t2i-adapter-sdxl-openpose', 'adirik/t2i-adapter-sdxl-lineart', 'storymy/take-off-eyeglasses', 'adirik/t2i-adapter-sdxl-canny', 'sujaykhandekar/object-removal', 'adirik/t2i-adapter-sdxl-sketch', 'lambdal/image-mixer', 'daanelson/plug_and_play_image_translation', 'cjwbw/pix2pix-zero', 'adirik/kosmos-g', 'cjwbw/repaint', 'adirik/masactrl-stable-diffusion-v1-4'],
    'AI Music Generation':['meta/musicgen', 'riffusion/riffusion', 'allenhung1025/looptest', 'nateraw/audio-super-resolution', 'haoheliu/audio-ldm', 'andreasjansson/music-inpainting-bert', 'sakemin/musicgen-remixer', 'andreasjansson/cantable-diffuguesion', 'harmonai/dance-diffusion', 'declare-lab/mustango', 'fofr/musicgen-choral', 'nateraw/musicgen-songstarter-v0.2', 'annahung31/emopia', 'sakemin/musicgen-stereo-chord', 'sakemin/musicgen-chord', 'lucataco/magnet'],
    #'':[],
}
